...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            m_RebindOperation = action.PerformInteractiveRebinding(bindingIndex)
                ...
                .OnComplete(
                    operation =>
                    {
                        ...
                        if (CheckForDuplicate(action, bindingIndex, allCompositeParts))
                        {
                            action.RemoveBindingOverride(bindingIndex);
                            CleanUp();
            ...
            // Give l
            // isteners a chance to act on the rebind starting.
        ...
        private bool CheckForDuplicate(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            foreach(InputBinding binding in action.actionMap.bindings)
            {
                ...
                {
                    if(!newBinding.isPartOfComposite) continue;


                    if (newBinding.name == binding.name) continue;

                }
                if (newBinding.effectivePath == binding.effectivePath) return true;
